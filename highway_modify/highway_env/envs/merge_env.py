...
class MergeEnv(AbstractEnv):
    ...
    def default_config(cls) -> dict:
        ...
        cfg.update({
            "observation": {
                "type": "Kinematics",
                "absolute": True,
                "features_range": {"x": [-500., 500.], "y":[-8.,8.], "vx":[-80.,80.], "vy":[-80.,80.]},
            },
            "finish_position": [400.0, 4.0],
            "collision_reward": -1,
    ...
    def _is_terminal(self) -> bool:
        ...
        return self.vehicle.crashed or self.vehicle.position[0] > 370 or not self.vehicle.on_road or self.steps >= self.config["duration"]
